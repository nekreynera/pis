<div class="modal" id="modal-new-list">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal ancillary-form" id="new-list-form" method="POST" action="<?php echo e(url('laboratorylist')); ?>">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-success btn-sm" form="new-list-form"><span class="fa fa-save"></span> Save</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
