<td class="text-center">
    <a href="<?php echo e(url('markAsApproved/'.$approval->approvalid)); ?>" class="btn btn-default btn-circle"
...
<td class="text-center">
    <a href="<?php echo e(url('markAsUnApproved/'.$approval->approvalid)); ?>" class="btn btn-default btn-circle"
