  	...
  	<div class="panel" id="classification_panel">
          ...
          <div class="submitclassificationloader">
            <img src="public/images/loader.svg">
  				...
  				<form class="mssformsubmit" method="post" action="<?php echo e(url('mss')); ?>">
          <?php echo e(csrf_field()); ?>

  				<table class="table table-bordered" id="PgovStatus">
  					<tr style="text-align: center;">
  						<td width="25%" >DATE OF INTERVIEW <br><?php echo e(Carbon::parse()->now()->format('Y/m/d h:i:a')); ?><br>
  						</td>

  						<input type="hidden" name="validity" value="<?php echo e(Carbon::now()->addYear()->format('Y-m-d')); ?>" id="validity" />
  						<input type="hidden" name="patients_id" value="<?php echo e($patient->id); ?>" id="patient_id" />
              <input type="hidden" name="users_id" value="<?php echo e(Auth::user()->id); ?>">
  						...
  						<td width="17%">HOSP NO <br> <font id="hosp_no"><?php echo e($patient->hospital_no); ?></font></td>
              ...
              <td><?php echo e(($patient->sex == 'M')?"MALE":"FEMALE"); ?></td>
                  ...
                  <option value="Sep-fact">Separated - infact</option>
  					...
  					<tr>
  						<td colspan="2" style="padding: 3px!important;">PERMANET ADDRESSS: <br><br><?php echo e($patient->address); ?></td>
  						<td colspan="2" style="padding: 3px!important;">
  							...
  							<input type="text" name="temp_address" id="address" data-toggle="modal" data-target="#myModal" class="form-control address" placeholder="Enter Address">
  												...
  												<td style="padding: 3px!important;text-align:center">DATE/PLACE OF BIRTH: <br><?php echo e($patient->birthday); ?><br>
