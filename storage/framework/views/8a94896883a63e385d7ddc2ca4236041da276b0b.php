<div id="alertModal" class="modal" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body bg-warning">
                <label>Hi doc, <span class="fa fa-file-text-o"></span> Laboratory result is now viewable through OPDRMS </label>
                <br>
                <br> 
                ...
                <div class="slideshow-container">
                    <div class="mySlides fades">
                        ...
                        <img src="<?php echo e(url('public/laboratory/demo/1.png')); ?>" style="width:100%">
                        <div class="text">Click incircle button to view patient medical records</div>
                    </div>

                    <div class="mySlides fades">
                        <div class="numbertext">1st step</div>
                        <img src="<?php echo e(url('public/laboratory/demo/4.png')); ?>" style="width:100%">
                        <div class="text">Click incircle button to view patient medical records</div>
                    </div>

                    <div class="mySlides fades">
                        <div class="numbertext">2nd step</div>
                        <img src="<?php echo e(url('public/laboratory/demo/2.png')); ?>" style="width:100%">
                    ...
                    <div class="mySlides fades">
                        ...
                        <img src="<?php echo e(url('public/laboratory/demo/3.png')); ?>" style="width:100%">
                     ...
                     <div class="mySlides fades">
                        ...
                        <img src="<?php echo e(url('public/laboratory/demo/5.png')); ?>" style="width:100%">
 ...
 -->
      ...
      <div class="modal-footer">
        <a href="<?php echo e(url('patientlist?alert=true')); ?>" class="btn btn-success btn-sm">Got it! <span class="fa fa-thumbs-up"></span></a>
      </div>
    </div>
  </div>
</div>