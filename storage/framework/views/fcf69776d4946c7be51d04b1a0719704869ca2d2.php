        ...
        <div class="container">
            <div class="row">
                <div class=" col-md-3 logoWrapper">
					...
					<img src="<?php echo e(asset('public/images/hem-doh.png')); ?>" class="img-responsive" />
                </div>
            ...
            <div class="row">
				<div class="col-md-6">
					<img src="<?php echo e(asset('public/images/login_sideimage.png')); ?>" class="img-responsive" alt="Philippine Emergency Medical Assistance Team" />
				</div>
                <div class="col-md-6">
