<div class="modal" id="modal-edit-mss-classification">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                Edit Mss Classification Window
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" id="edit-sponsors" method="POST" action="<?php echo e(url('#')); ?>">
                    ...
                    <div class="form-group">
                        <div class="col-md-5 col-sm-5 col-xs-6">
                            ...
                            <input type="text" name="discount" class="form-control discount text-right" placeholder="Discount..." readonly>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success btn-sm" form="edit-sponsors" id="save"><span class="fa fa-save"></span> Update</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
