                ...
                <form action="{{ url('industrial') }}" method="post" id="industrialMainForm">
                    ...
                    <div class="col-md-12 row">
                        <div class="form-inline">
                            ...
                            @if(count($vital_signs) > 0) value="{{ $vital_signs[0]->blood_pressure }}" @endif/>
                            <label>mmHg,</label>
                            <strong class="strng">HR</strong>
                            <input type="text" name="hr" class="styledFormSmall"
                            @if(count($vital_signs) > 0) value="{{ $vital_signs[0]->pulse_rate }}" @endif/>
                            <label>bpm,</label>
                            <strong class="strng">RR</strong>
                            <input type="text" name="rr" class="styledFormSmall"
                            @if(count($vital_signs) > 0) value="{{ $vital_signs[0]->respiration_rate }}" @endif/>
                            <label>cpm,</label>
                            <strong class="strng">Temp</strong>
                            <input type="text" name="temp" class="styledFormSmall"
                            @if(count($vital_signs) > 0) value="{{ $vital_signs[0]->body_temperature }}" @endif/>
                            <label> &#176;C,</label>
