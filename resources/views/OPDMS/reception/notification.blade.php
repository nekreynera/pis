...
<li class="dropdown messages-menu search_queue_wrapper">
    ...
    <ul class="dropdown-menu">
        ...
        <li class="search_queued_parent_list">
            ...
            <ul class="menu">
                <li><!-- start notification -->
                    <form action="{{ url('search_queued_patients') }}" method="post">
                        {{ csrf_field() }}
...
<li class="dropdown messages-menu">
    ...
    <a href="#" class="dropdown-toggle" id="registeredPatientCount" data-toggle="dropdown">
        ...
        {{--<span class="label label-success">{{ $registerPatient }}</span>--}}
    ...
    <ul class="dropdown-menu">
        ...
        <li class="footer">
            <a href="{{ url('search_patient/'.Carbon::now()->toDateString().'/register.search') }}">
