                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table table-bordered" border="0">
                                    ...
                                    <tr>
                                        <td>CASHIER: <b>{{ strtoupper(Auth::user()->first_name.' '.substr(Auth::user()->middle_name,0,1).'. '.Auth::user()->last_name) }}</b></td>
...
@section('pagescript')
    ...
    <script src="{{ asset('public/js/cashier/transaction.js?v1.0.1') }}"></script>
