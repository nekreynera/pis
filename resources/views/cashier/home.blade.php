    ...
    @component('cashier/dashboard')
        @section('main-content')
            <div class="container-fluid cashier-container" style="margin-top: 70px;">
                <form class="submittransaction" method="post" action="{{ url('submittransaction') }}">
                <div class="col-md-9">
                        <div class="col-md-12">
            ...
            <!-- .content-wrapper -->
            @include('cashier.modals.alert')
            @include('cashier.modals.walkin')
...
@section('pagescript')
    ...
    <script src="{{ asset('public/js/cashier/main.js?v1.0.1') }}"></script>
    ...
    <script src="{{ asset('public/js/cashier/income.js?v1.0.3') }}"></script>
    <script src="{{ asset('public/js/cashier/walkin.js') }}"></script>
    <script src="{{ asset('public/js/cashier/address.js') }}"></script>
@stop
