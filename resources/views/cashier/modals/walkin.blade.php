    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal walk-in-form" id="walk-in-form" method="POST" action="{{ url('walkinpatient') }}"> 
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <select name="region" class="form-control region select2" style="width: 100%;" required>
                                                ...
                                                @foreach($regions as $region)
                                                    ...
                                                    <option value="{{ $region->regCode }}" @if($region->regCode == '08') selected @endif>{{ $region->regDesc }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-xs-6">
                                            ...
                                            <select name="province" class="form-control province select2" style="width: 100%;" required>
                                                ...
                                                @foreach($provinces as $province)
                                                    ...
                                                    <option value="{{ $province->provCode }}" @if($province->provCode == '0837') selected @endif>{{ $province->provDesc }}</option>
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <select name="city_municipality" class="form-control city_municipality select2" style="width: 100%;" required>
                                                ...
                                                @foreach($citys as $city)
                                                    <option value="{{ $city->citymunCode }}" @if($city->citymunCode == '083747') selected @endif>{{ $city->citymunDesc }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-xs-6">
                                            ...
                                            <select name="brgy" class="form-control brgy select2" style="width: 100%;">
                                                <option value="" hidden>--</option>
                                                 @foreach($brgys as $brgy)
                                                    <option value="{{ $brgy->id }}">{{ $brgy->brgyDesc }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
